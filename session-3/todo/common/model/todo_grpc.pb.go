...
func (c *todoServiceClient) GetAll(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetAllResponse, error) {
...
func (UnimplementedTodoServiceServer) GetAll(context.Context, *empty.Empty) (*GetAllResponse, error) {
